...
-- Update Data Engineer role priority level to 1
UPDATE priority_mart.priority_roles
SET priority_lvl = 1
WHERE role_name = 'Data Engineer';

-- add Data Scientist role with priority level 3
...
-- Create TEMP table
CREATE OR REPLACE TEMP TABLE temp_priority_jobs_snapshot AS
SELECT
    jpf.job_id,
    jpf.job_title_short,
...
USING temp_priority_jobs_snapshot AS src
