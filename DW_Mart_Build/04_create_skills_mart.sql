...
SELECT 'Skill dimension' AS table_name, COUNT(*) AS records_count FROM skills_mart.dim_skills
UNION ALL
SELECT 'Date Month dimension', COUNT(*) AS records_count FROM skills_mart.dim_date_month
UNION ALL
SELECT 'Skill Demand fact', COUNT(*) AS records_count FROM skills_mart.fact_skill_demand_monthly;
